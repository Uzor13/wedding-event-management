...
declare global {
  var _mongooseEventModel: Model<IEvent> | undefined;
}

const Event = mongoose.models.Event || global._mongooseEventModel || (global._mongooseEventModel = mongoose.model<IEvent>('Event', eventSchema));
